...
export default function Home() {
    ...
    return (
        <div className={`min-h-screen ${isDark ? 'bg-gradient-to-b from-[#1a2544] via-[#1a2544]/80 to-[#1a2544]' : 'bg-gradient-to-b from-[#f8fafc] via-[#f1f5f9] to-[#f8fafc]'} transition-colors duration-300`}>
            {/* Hero Section */}
            <Parallax
                blur={0}
            ...
            >
                    ...
                    <div className="flex flex-col justify-center items-center text-center w-full md:w-2/3 space-y-8">
                        ...
                        >
                            ...
                            <motion.button
                                ...
                                className={`border-2 border-[#FFA600] px-8 py-3 rounded-xl font-medium hover:bg-[#FFA600] transition-all duration-300 ${isDark ? 'text-white hover:text-white' : 'text-gray-800 hover:text-white'}`}
                            >
                                Let's Connect
                            </motion.button>
                        </motion.div>
                ...
                >
                    <ArrowDown className={`w-8 h-8 ${isDark ? 'text-[#FFA600]' : 'text-blue-500'}`} />
                </motion.div>
            </Parallax>

            {/* Expertise Section */}
            <div className="relative py-32">
                <div className={`absolute inset-0 ${isDark ? 'bg-gradient-to-b from-[#1a2544]/50 to-[#1a2544]' : 'bg-gradient-to-b from-[#f8fafc]/50 to-[#f8fafc]'} opacity-50`} />
            ...
            {/* Contact Section */}
            <div id="contact" className={`relative ${isDark ? 'bg-[#1a2544]' : 'bg-[#f8fafc]'}`}>
