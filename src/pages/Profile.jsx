...
export default function Profile() {
    ...
    const softSkills = [
        "Aisance relationnelle et communication régulière",
        "Patience, compréhension et gestion des attentes",
                        ...
                        <div className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-12">
                            <div className="w-48 h-48 relative rounded-full border-2 border-white">
                                ...
                                <img
                                    src="/Eloïc.jpg"
                                    alt="Profile"
                                    className="w-full h-full object-cover rounded-full border-4 border-white relative"
                                />
                            </div>
                            ...
                            <div className="flex-1 text-center md:text-left">
                                ...
                                <p className="text-lg text-gray-300 max-w-2xl">
                                    Ayant déjà quelques début en tant que professionel, je cherche toujours de nouveaux défis pour grandir dans le milieu du développement web.
                                    Mener à bien vos projets et m'assurer de votre satisfaction sont mes principaux objectifs.
                                </p>
                            </div>
                        </div>
                    </div>
