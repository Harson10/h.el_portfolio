...
export default function ContactForm({ isDark = true }) {
    ...
    const inputClasses = `w-full ${isDark ? 'bg-[#293556]/50 border-white/10 placeholder:text-white/30' : 'bg-gray-100 border-white placeholder:text-gray-400'} 
    ...
    return (
        <motion.div
            ...
            viewport={{ once: true }}
            className={`w-full max-w-4xl mx-auto ${isDark ? 'bg-[#1a2544]/50 border-white/10' : 'bg-gray-300/50 border-gray-300'} 
