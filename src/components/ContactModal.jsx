...
const ContactModal = ({ isOpen, onClose }) => {
    ...
    const validateForm = () => {
        ...
        if (!email.trim() || !emailRegex.test(email)) return "Veuillez entrer une adresse email valide";
...
// import { X, Linkedin, Github, Mail, Send } from 'lucide-react';
// import { useState } from 'react';
// import PropTypes from 'prop-types';
...
//                     <button
//                         type="submit"
//                         className="w-full bg-[#FFA600] text-black font-bold py-2 rounded-lg hover:bg-[#FF8C00] transition-colors flex items-center justify-center gap-2"
//                     >
//                         <Send size={20} />
//                         Envoyer
//                     </button>
